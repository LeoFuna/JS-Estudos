...
console.log('obj.__proto === Object.prototype', obj.__proto__ === Object.prototype)
assert.deepStrictEqual(obj.__proto__, Object.prototype)

console.log('arr.__proto === Array.prototype', arr.__proto__ === Array.prototype)
assert.deepStrictEqual(arr.__proto__, Array.prototype)

console.log('fn.__proto === Function.prototype', fn.__proto__ === Function.prototype)
...
// se nao chamar o 'new', o primeiro __proto__ vai ser sempre a instancia de Function,
// sem herdar nossas classes
...
// quando chamamos com o 'new' o __proto__ recebo o prototype
console.log('manager__proto__: %s, manager.salary(): %s', new Manager().__proto__, new Manager().salary())
