...
describe('CarService Suite Tests', () => {
  ...
  it('given a carCategory, customer and numberOfDays it should calculate final amount in real', async () => {
    //O Object.create é para criar uma nova instância para que a alteraçao do .age nao possa ter efeito
    // nos outros testes que usem o validCustomer
    ...
    // esse stub garante se a implementaçao de taxesBasedOnAge mudar, esse teste nao terá problema para testar o calculo
    sandbox.stub(
      carService,
      'taxesBasedOnAge'
    ).get(() => [{ from: 40, to: 50, then: 1.3 }])

    // Classe nativa do JS que permite formatar números.
